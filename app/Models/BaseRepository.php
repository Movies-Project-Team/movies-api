...
abstract class BaseRepository
{
    ...
    public function upsert( array $uniqueColumns, array $updateColumns)
    {
        $data = $this->findByAttributes($uniqueColumns);

        if ($data) {
            $data->update($updateColumns);
        } else {
            $data = $this->_db->create($updateColumns);
        }
